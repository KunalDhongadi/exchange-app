...
const Explore = () => {
  ...
  let selectedBtnClass =
    "text-white bg-gray-800 rounded-md focus:ring-4 focus:outline-none font-medium text-sm px-5 py-2.5 text-center mr-2 mb-2";

  let unselectedBtnClass =
    "text-gray-800 hover:text-white border rounded-md border-gray-800 hover:bg-gray-800 focus:ring-4 focus:outline-none  font-medium text-sm px-5 py-2.5 text-center mr-2 mb-2";
